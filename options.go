...
//
// Since calculating the size of a generic map in memory incurrs a heavy
// performance cost, the capacity of a cache is defined as the total number of
// keys it is allowed to hold.
